...
if(isset($_POST['submit']))
{
  ...
  $query= mysqli_query($con, "update facexperience set Fac_no='$fno',  Experience ='$eoy', Department ='$dept', College_Mail_ID ='$cmid', Full_Name='$fullname', Date_Of_Birth ='$dob', Gender ='$gender', Blood_Group='$bg', Qualification='$qual', Designation ='$desgn', Mobile_No ='$mobno', Parents_Mob_No='$pmobno', Residential_Address='$res_add', Telephpne_No='$telno', State='$state', District='$district', Joining_Date='$jd', Pin_Code=$pin_code, Permenant_Address='$p_add', Father_Name='$fname', Father_Occupation='$foccup', Mother_Name='$mname', Mother_Occupation='$moccup', Mob_No='$mob_no', Family_Income='$fincome', PEID='$peid', Achievements_2='$achv2', Achievements_3='$achv3', Achievements_4='$achv4', Achievements_5='$achv5'  where EmpID=$eid");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Faculty Details</h1>
...
?>
               <div class="row">
                <div class="col-4 mb-3">Enter Faculty No.</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user"  id="fno" name="fno" aria-describedby="emailHelp" value="<?php  echo $row['Fac_no'];?>"></div>
                    </div>  
