...
if(isset($_POST['submit']))
  {
    ...
    $Email=$_POST['Email'];
        ...
        $query=mysqli_query($con,"select ID from studentdetail where  SEmail='$Email' and PRN_No='$empid' ");
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="empid" name="empid" placeholder="Enter your PRN Number" required="true">
                    </div>
