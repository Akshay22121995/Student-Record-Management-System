...
$query=mysqli_query($con,"select ID from studentdetail where ID='$empid' and 	EmpPassword='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update studentdetail set EmpPassword='$newpassword' where ID='$empid'");
...
<form name="changepassword" class="user" method="post" onsubmit="return checkpass();">
  <?php
$cid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from studentdetail where ID='$cid'");
$cnt=1;
