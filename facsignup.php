...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $query = "SELECT Femail FROM facdetails WHERE Femail = '$Femail'";
  //Executing Query
  ...
  if (mysqli_num_rows($result)>0) {
    $msg="This email already associated with another account";
      ...
      $query = "SELECT * FROM facdetails";
    $result = mysqli_query($connection, $query);

    $Empid = mysqli_num_rows($result) + 1;
      
    $query = "INSERT INTO facdetails(Ffname, Flname, Fac_no, Femail, Fpassword) VALUES ('$Ffname', '$Flname', '$Facno', '$Femail', '$Fpassword') ";

    $result = mysqli_query($connection, $query);
      
      $query = "INSERT INTO facexperience(EmpID, Fac_no, Femail) VALUES('$Empid', '$Facno', '$Femail')";
    $result = mysqli_query($connection, $query);
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 3%"> <b>Student & Faculty Record Managment System</b> </h3>
          ...
          <div class="col-lg-9">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create a Faculty Account!</h1>
              </div>
              ...
              <form class="user" name="register" method="post" onsubmit="return checkpass();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="facno" name="facno" placeholder="Enter your Faculty Number" pattern="[0-9]+" required="true">
                </div>
              ...
              <div class="text-center">
                <a class="small" href="facsignin.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
