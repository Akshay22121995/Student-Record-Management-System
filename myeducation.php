    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">My Education Details</h1>
...
<?php 
$empid=$_SESSION['uid'];
$query=mysqli_query($con,"select * from steducation where EmpID=$empid");
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <tr>
  <th>Current Course Name</th>
  <td><?php echo $row['CoursePG'];?></td>
</tr>

<tr>
  <th>Year of Admission</th>
  <td><?php echo $row['YearOfAdmission'];?></td>
</tr>
